"""Módulo de clientes: tabla de listado + formulario de alta/edición."""
import sqlite3
...
class FrameClientes(tk.Frame):
    ...
    def _construir_busqueda(self):
        ...
        ttk.Label(barra, text="Buscar cliente:").pack(side="left")
    ...
    def _construir_tabla(self):
        ...
        encabezados = {
            "id": ("ID", 40, tk.CENTER),
            "documento": ("Documento", 110, tk.CENTER),
            "nombre": ("Nombre", 150, tk.W),
            "apellido": ("Apellido", 150, tk.W),
            "telefono": ("Teléfono", 110, tk.CENTER),
            "email": ("Email", 190, tk.W),
            "fecha_registro": ("Registro", 100, tk.CENTER),
        }
    ...
    def _construir_formulario(self):
        form = ttk.LabelFrame(self, text="Formulario de cliente", padding=10)
        ...
        campos = [
            ...
            (1, 0, "Documento", self.var_documento),
        ...
        ttk.Label(form, text="Fecha de registro: automática (hoy)").grid(
    ...
    def _guardar(self):
        try:
            ...
            return
        messagebox.showinfo("Clientes", "Cliente guardado correctamente.", parent=self)
        self._limpiar()
        self.refrescar()
    ...
    def _editar(self):
        ...
        self.var_documento.set(valores["documento"])
